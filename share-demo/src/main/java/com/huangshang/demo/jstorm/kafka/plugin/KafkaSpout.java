 ...
 */
package com.huangshang.demo.jstorm.kafka.plugin;
...
//	private static Logger LOG = LoggerFactory.getLogger(KafkaSpout.class);
	...
	public void open(Map conf, TopologyContext context, SpoutOutputCollector collector) {
		System.err.println("KafkaSpout#open");
	...
	public void close() {
		...
		System.err.println("KafkaSpout#close");
...
//			System.err.println("====== [KafkaSpout#nextTuple] partition "+ consumer.getPartition() + " emit message state is "+state);
